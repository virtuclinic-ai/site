...
Let look at a scenario where we are **flipping a coin**, there is exactly 2 things that can happen here, either the how coin fell on *tail* or *head*. So the sample space in this case is the set of possible outcomes in other world an ensemble that contains all the states that our system (flipping a coin) can take.
